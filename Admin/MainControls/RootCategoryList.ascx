<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RootCategoryList.ascx.cs"
    Inherits="AdminAdvanced_MainControls_RootCategoryList" %>
...
<uc1:AdminContent ID="uxAdminContent" runat="server" HeaderText="<%$ Resources:lcHeader %>">
    ...
    <GridTemplate>
        <asp:GridView ID="uxGrid" runat="server" CssClass="Gridview1" SkinID="DefaultGridView"
            DataKeyNames="CategoryID" OnDataBound="uxGrid_DataBound" OnRowCommand="uxGrid_RowCommand"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="CategoryID" HeaderText="<%$ Resources:CategoryFields, CategoryID %>"
                    SortExpression="CategoryID">
                    <ItemStyle HorizontalAlign="Center" Width="10%" />
                </asp:BoundField>
                <asp:TemplateField HeaderText="<%$ Resources:CategoryFields, Name %>" SortExpression="Name">
                    <EditItemTemplate>
                        ...
                        <asp:RequiredFieldValidator ID="uxNameRequired" runat="server" ErrorMessage="Root category name is required"
                            ControlToValidate="uxNameText" ValidationGroup="ValidRootCategory" Display="None">*</asp:RequiredFieldValidator>
                    </EditItemTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField ShowHeader="false">
                    <ItemTemplate>
                        <vevo:AdvancedLinkButton ID="uxCategoryLinkButton" runat="server" PageName="CategoryList.ascx"
                            PageQueryString='<%# String.Format("RootID={0}",Eval("CategoryID")) %>' Text="Category"
                ...
                <asp:TemplateField HeaderText="<%$ Resources:CategoryFields, EditCommand %>">
                    <EditItemTemplate>
                        <vevo:LinkButton ID="uxUpdateLinkButton" runat="server" CausesValidation="true" CommandName="Update"
                            Text="Update" CssClass="UnderlineDashed" ValidationGroup="ValidRootCategory" />
                        <vevo:LinkButton ID="uxCancelLinkButton" runat="server" CausesValidation="false"
                            CommandName="Cancel" Text="Cancel" ValidationGroup="ValidRootCategory" CssClass="UnderlineDashed" />
                    </EditItemTemplate>
                    <ItemTemplate>
                    ...
                    <FooterTemplate>
                        <vevo:AdvanceButton ID="uxAddLinkButton" runat="server" meta:resourcekey="uxAddButton" CssClassBegin="mgCenter" CssClassEnd="Button1Right" CssClass="ButtonOrange ButtonCenter" CommandName="Add"
                            OnClickGoTo="Top" ValidationGroup="ValidRootCategory" />
                    </FooterTemplate>
