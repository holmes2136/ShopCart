<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CategoryDetails.ascx.cs"
    Inherits="AdminAdvanced_Components_CategoryDetails" %>
...
<uc2:AdminContent ID="uxAdminContent" runat="server">
    ...
    <ValidationSummaryTemplate>
        <asp:ValidationSummary ID="uxValidationSummary" runat="server" meta:resourcekey="uxValidationSummary"
            ValidationGroup="VaildCategory" CssClass="ValidationStyle" />
    </ValidationSummaryTemplate>
    ...
    <ContentTemplate>
        <div class="Container-Row">
            <div class="CommonRowStyle">
                ...
                <asp:TextBox ID="uxNameText" runat="server" Width="250px" ValidationGroup="VaildCategory"
                    CssClass="TextBox" />
                ...
                <asp:RequiredFieldValidator ID="uxNameRequiredValidator" runat="server" ControlToValidate="uxNameText"
                    Display="Dynamic" ValidationGroup="VaildCategory" CssClass="CommonValidatorText">
                            <img src="../Images/Design/Bullet/RequiredFillBullet.gif" /> Category name is required.
            ...
            <div class="CommonRowStyle">
                ...
                <asp:LinkButton ID="uxImageCategoryLinkButton" runat="server" OnClick="uxImageCategoryLinkButton_Click"
                    CssClass="fl mgl5">Upload...</asp:LinkButton>
                <uc6:Upload ID="uxImageCategoryUpload" runat="server" ShowControl="false" CheckType="Image"
            ...
            <asp:Panel ID="uxLayoutSettingPanel" runat="server">
                ...
                <asp:Panel ID="uxLayoutRadioPanel" runat="server" CssClass="CommonRowStyle">
                    ...
                    <asp:RadioButtonList ID="uxLayoutTypeRadioButtonList" runat="server" CssClass="fl">
                        <asp:ListItem Text="Sub-Categories" Value="Category" Selected="True" />
                        <asp:ListItem Text="Products" Value="Product" />
                    </asp:RadioButtonList>
                </asp:Panel>
                <asp:Panel ID="uxCategoryLayoutPanel" runat="server" CssClass="CommonRowStyle">
                    <asp:Label ID="uxCategoryLayoutLabel" runat="server" meta:resourcekey="lcCategoryLaout"
                        CssClass="BulletLabel" />
                    <asp:DropDownList ID="uxCategoryLayoutDrop" runat="server" CssClass="fl DropDown">
                    </asp:DropDownList>
                </asp:Panel>
            ...
            <div id="uxIsAnchorTR" runat="server" class="CommonRowStyle">
                <asp:Label ID="uxIsAnchorLabel" runat="server" meta:resourcekey="uxIsAnchorLabel"
                    CssClass="Label" />
                <asp:CheckBox ID="uxIsAnchorCheck" runat="server" CssClass="fl CheckBox" />
            </div>
            <div id="uxIsShowNewArrivalTR" runat="server" class="CommonRowStyle">
                ...
                <asp:CheckBox ID="uxIsShowNewArrivalCheck" runat="server" CssClass="fl CheckBox"
                    OnCheckedChanged="uxIsShowNewArrivalCheck_CheckedChanged" AutoPostBack="true" />
            </div>
            ...
            <div class="mgt10">
                <vevo:AdvanceButton ID="uxAddButton" runat="server" meta:resourcekey="uxAddButton"
                    ...
                    OnClick="uxAddButton_Click" OnClickGoTo="Top" ValidationGroup="VaildCategory">
                </vevo:AdvanceButton>
                <vevo:AdvanceButton ID="uxUpdateButton" runat="server" meta:resourcekey="uxUpdateButton"
                    CssClassBegin="mgt10 mgl10 fr" CssClassEnd="Button1Right" CssClass="ButtonOrange"
                    OnClick="uxUpdateButton_Click" OnClickGoTo="Top" ValidationGroup="VaildCategory">
                </vevo:AdvanceButton>
                <div class="Clear" />
            </div>
        </div>
