...
public partial class Mobile_Components_PromotionProductItem : BaseLanguageUserControl
{
    ...
    protected void uxOkButton_Click( object sender, EventArgs e )
    {
        if (uxOptionGroupDetails.IsValidInput)
        {
            ...
            {
                uxOptionHidden.Value = item.OptionItemID + ",";
            }

            uxOptionHidden.Value = uxOptionHidden.Value.TrimEnd( ',' );
        }
        else
        {
            uxOptionHidden.Value = "Error";
    ...
    public void SetNoBorderBottomCss()
    {
        uxMobilePromotionProductItemDiv.Style.Add( "Border-bottom", "None" );
    }
}
