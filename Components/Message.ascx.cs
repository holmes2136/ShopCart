...
public partial class Components_Message : System.Web.UI.UserControl, Vevo.WebUI.IMessageControl
{
    ...
    public void DisplayMessageNoNewLIne( string text, params object[] parameters )
    {
        ...
        uxMessageDiv.Attributes.Add( "class", "CommonDisplayMessageDiv" );
    ...
    public void DisplayErrorNoNewLine( string text, params object[] parameters )
    {
        ...
        uxMessageDiv.Attributes.Add( "class", "CommonErrorMessageDiv" );
        uxMessageDiv.Visible = true;
    }
