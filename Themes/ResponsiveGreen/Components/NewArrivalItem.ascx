<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NewArrivalItem.ascx.cs"
    Inherits="Themes_ResponsiveGreen_Components_NewArrivalItem" %>
...
<asp:Panel ID="uxNewArrivalItemPanel" runat="server" CssClass="NewArrivalItemStyle">
    ...
    <div class="NewArrivalItem">
        ...
        <asp:Panel ID="uxQuantityDiscountPanel" runat="server" Visible='<%# CatalogUtilities.GetQuantityDiscountByProductID( Eval("DiscountGroupID"), Eval("CategoryIDs") ) %>'
