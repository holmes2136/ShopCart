<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PromotionSubGroupSorting.ascx.cs"
    Inherits="AdminAdvanced_MainControls_PromotionSubGroupSorting" %>
    ...
    <GridTemplate>
        <div class="CommonAdminBorder Container-Box1">
            <div class="CategorySortingLabel">
                <asp:Label ID="uxPromotionSubGroupSortingLabel" runat="server" meta:resourcekey="lcPromotionSubGroupSortingLabel"></asp:Label>
            </div>
