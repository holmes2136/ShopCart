<%@ Page Language="C#" MasterPageFile="~/Front.master" AutoEventWireup="true" CodeFile="AddToCart.aspx.cs"
    Inherits="AddToCart" Title="Add To Shopping Cart" %>
        ...
        <div class="CommonPageLeft">
            <div class="CommonPageRight">
                <asp:Panel ID="uxProductNotExistMessagePanel" runat="server" Visible="false">
                    <div class="AddToCartNotCompleteContent">
