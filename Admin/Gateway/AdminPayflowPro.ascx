<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdminPayflowPro.ascx.cs"
    Inherits="Admin_Gateway_AdminPayflowPro" %>
...
<uc1:StoreMultiSelect ID="uxStoreSelect" runat="server" PaymentName="Payflow Pro" />
