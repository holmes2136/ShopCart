<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TaxClassList.ascx.cs"
    Inherits="AdminAdvanced_MainControls_TaxClassList" %>
...
<uc1:AdminContent ID="uxAdminContent" runat="server" HeaderText="<%$ Resources:lcHeader %>">
    ...
    <GridTemplate>
        <asp:GridView ID="uxTaxClassGrid" runat="server" CssClass="Gridview1" SkinID="DefaultGridView"
            DataKeyNames="TaxClassID" OnDataBound="uxTaxClassGrid_DataBound" OnRowCommand="uxTaxClassGrid_RowCommand"
            OnRowUpdating="uxTaxClassGrid_RowUpdating" AllowSorting="true" OnSorting="uxTaxClassGrid_Sorting"
            OnRowDataBound="uxGrid_RowDataBound" ShowFooter="false" OnRowEditing="uxTaxClassGrid_RowEditing"
            OnRowCancelingEdit="uxTaxClassGrid_CancelingEdit">
            <%--AutoGenerateColumns="False" ShowFooter="false"--%>
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
                        <input type="CheckBox" name="SelectAllCheckBox" onclick="SelectAllCheckBoxes(this , 'uxTaxClassGrid')">
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="<%$ Resources:TaxClassID %>" SortExpression="TaxClassID">
                    <EditItemTemplate>
                        <asp:Label ID="uxTaxClassIDLabel" runat="server" Text='<%# Eval("TaxClassID") %>'></asp:Label>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="uxTaxClassIDLabel" runat="server" Text='<%# Eval("TaxClassID") %>'></asp:Label>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="<%$ Resources:Name %>" SortExpression="TaxClassName">
                    <EditItemTemplate>
                        <asp:TextBox ID="uxNameText" runat="server" Text='<%# Eval("TaxClassName") %>' CssClass="TextBox"
                            Width="250px"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="uxNameRequired" runat="server" ErrorMessage="Tax Class name is required"
                            ControlToValidate="uxNameText" ValidationGroup="VaildTaxClass" Display="None">*</asp:RequiredFieldValidator>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="uxNameLabel" runat="server" Text='<%# Eval("TaxClassName") %>'></asp:Label>
                    </ItemTemplate>
                ...
                <asp:TemplateField ShowHeader="false">
                    <ItemTemplate>
                        <vevo:AdvancedLinkButton ID="uxRuleLinkButton" runat="server" PageName="TaxClassRuleList.ascx"
                            PageQueryString='<%# String.Format("TaxClassID={0}", Eval("TaxClassID")) %>'
                ...
                <asp:TemplateField ShowHeader="False">
                    <EditItemTemplate>
                        ...
                        <vevo:LinkButton ID="uxCancelLinkButton" runat="server" CausesValidation="False"
                            CommandName="Cancel" Text="<%$ Resources:CommandCancel %>" ValidationGroup="VaildTaxClass"
                    ...
                    <FooterTemplate>
                        <vevo:AdvanceButton ID="uxAddLinkButton" runat="server" meta:resourcekey="uxAddLinkButton"
                            ...
                            CommandName="Add" OnClickGoTo="Top" ValidationGroup="ValidTaxClass" />
                    </FooterTemplate>
                    <HeaderStyle Width="100px" HorizontalAlign="Center" />
                    <ItemStyle Width="100px" HorizontalAlign="center" />
                    <FooterStyle HorizontalAlign="Center" />
            ...
            <EmptyDataTemplate>
                <asp:Label ID="uxEmptyMessageLabel" runat="server" Text="<%$ Resources:lcEmptyTaxClassList  %>"></asp:Label>
            </EmptyDataTemplate>
        </asp:GridView>
    </GridTemplate>
</uc1:AdminContent>
