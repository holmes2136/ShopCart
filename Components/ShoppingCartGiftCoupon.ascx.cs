...
public partial class Components_ShoppingCartGiftCoupon : Vevo.WebUI.International.BaseLanguageUserControl
{
    ...
    private void DisplayGiftDetail()
    {
        ...
        StoreContext.CheckoutDetails.GiftCertificate = giftCertificate;
    }
    ...
    private void DisplayCouponDetails()
    {
        ...
        Coupon coupon = DataAccessContext.CouponRepository.GetOne( uxCouponIDText.Text );
        StoreContext.CheckoutDetails.Coupon = coupon;
