<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DepartmentImport.ascx.cs"
    Inherits="Admin_MainControls_DepartmentImport" %>
...
<uc1:AdminContent ID="admin" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="uxImportDepartmentMessagePanel" runat="server" CssClass="CommonRowStyle">
        </asp:Panel>
        <div class="Container-Row">
            <div class="CommonRowStyle">
                <div class="Label">
                    Type in File Name</div>
                <asp:TextBox Width="300" ID="uxDepartmentCsvFileNameText" runat="server" CssClass="fl TextBox"></asp:TextBox>
                <div class="Clear">
                </div>
            </div>
            <div class="CommonRowStyle">
                <div class="Label">
                    &nbsp;</div>
                <asp:Label ID="uxSampleDepartmentCsvLabel" runat="server" Text="<i>( Example : import\xxxxx.csv )</i>"></asp:Label>
            </div>
            ...
            <div class="CommonRowStyle">
                <div class="Label">
                    <vevo:AdvancedLinkButton ID="uxDepartmentCsvFileNameUploadLinkButton" runat="server"
                        OnClick="uxDepartmentCsvFileNameUploadLinkButton_Click" Text="Upload A File"
                        CssClassBegin="fl" CssClassEnd="Button1Right" CssClass="ButtonOrange" />
                </div>
                <div class="Clear">
                </div>
            </div>
            <uc3:Upload ID="uxDepartmentCsvFileUpload" runat="server" ShowControl="false" PathDestination="Import\"
            ...
            <div class="CommonRowStyle">
                <div class="Label">
                    Import Mode</div>
                <asp:RadioButtonList ID="uxDepartmentImportModeRadioList" runat="server" RepeatDirection="Horizontal"
            ...
            <vevo:AdvanceButton ID="uxDepartmentImportButton" runat="server" Text="Import" CssClassBegin="mgt10 fr"
                CssClassEnd="Button1Right" CssClass="ButtonOrange" OnClick="uxDepartmentImportButton_Click"
