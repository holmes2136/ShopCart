...
public partial class Mobile_Components_PromotionItem : BaseLanguageUserControl
{
    ...
    private void SetList()
    {
        ...
        if (newList.Count <= 0)
            Response.Redirect( "~/Mobile/Promotion.aspx" );
    ...
    protected void Page_Load( object sender, EventArgs e )
    {
        if (!DataAccessContext.Configurations.GetBoolValue( "EnableBundlePromo", StoreContext.CurrentStore ))
            Response.Redirect( "~/" + Vevo.UrlManager.MobileFolder + "/Default.aspx" );
    ...
    protected void uxTellFriendLinkButton_Click( object sender, EventArgs e )
    {
        ...
        Response.Redirect( UrlManager.GetPromotionTellFriendMobileUrl( group.PromotionGroupID, group.UrlName ) );
    }
