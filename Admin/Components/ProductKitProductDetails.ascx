<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProductKitProductDetails.ascx.cs"
    Inherits="Admin_Components_ProductKitProductDetails" %>
...
<asp:Panel ID="uxAddItemPanel" runat="server" CssClass="b6 pdl10 pdr10 pdb10 pdt10">
    ...
    <div class="ProductDetailsRow">
        <div id="uxCustomPriceDiv" runat="server">
            <asp:Label ID="uxPriceLable" runat="server" Text="Product Price" CssClass="Label" />
    ...
    <div id="uxQuantityPanel" runat="server">
        <div class="ProductDetailsRow">
            ...
            <asp:TextBox ID="uxQuantityText" runat="server" Width="70px" CssClass="TextBox fl" />
    ...
    <div class="ProductDetailsRow">
        <asp:Label ID="uxIsUserDefinedQuantity" runat="server" Text="Is User Defined Quantity"
            CssClass="Label" />
        <asp:CheckBox ID="uxIsUserDefinedQuantityCheck" runat="server" CssClass="CheckBox fl" />
    </div>
    <div class="ProductDetailsRow">
        <asp:Label ID="uxIsDefault" runat="server" Text="Is Default" CssClass="Label" />
        <asp:CheckBox ID="uxIsDefaultCheck" runat="server" CssClass="CheckBox fl" />
    </div>
    <%--<div class="ProductDetailsRow" id="uxAllOptionCheckPanel" runat="server">
        ...
        <asp:CheckBox ID="uxAllOptionCheck" runat="server"
            AutoPostBack="true" OnCheckedChanged="uxAllOptionCheck_OnCheckedChanged" CssClass="CheckBox fl" />
    </div>--%>
