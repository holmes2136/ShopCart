<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecentlyViewProduct.ascx.cs"
    Inherits="Themes_ResponsiveGreen_Components_RecentlyViewProduct" %>
    ...
    <div class="SidebarLeft">
        <div class="SidebarRight">
            <asp:DataList ID="uxList" runat="server" ShowFooter="False" CssClass="RecentlyViewedList">
                <HeaderStyle />
                <ItemTemplate>
                    <div class="ImageRecentPost" id="uxImageRecentPostDiv" runat="server" visible="true">
                        <asp:Image ID="uxItemImage" runat="server" ImageUrl='<%#GetItemImage( Eval( "ImageSecondary" )) %>'
                            Width="25" Height="25" ImageAlign="Middle" CssClass="RecentlyItemImageDiv" />
                    </div>
                    <div class="RecentlyItemName" id="Div1" runat="server">
