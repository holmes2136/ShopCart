<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Header.ascx.cs" Inherits="Blog_Themes_ResponsiveGreen_LayoutControls_Header" %>
<%@ Register Src="~/Components/HeaderLogo.ascx" TagName="HeaderImageLogo" TagPrefix="uc1" %>
<%@ Register Src="~/Themes/ResponsiveGreen/Components/HeaderLogin.ascx" TagName="HeaderLogin"
    TagPrefix="uc3" %>
...
<%@ Register Src="~/Themes/ResponsiveGreen/Components/CurrentShoppingCart.ascx" TagName="CurrentShoppingCart"
    TagPrefix="uc6" %>
<%@ Register Src="~/Themes/ResponsiveGreen/Components/QuickSearch.ascx" TagName="Search"
    TagPrefix="uc7" %>
        ...
        <div class="main-right-2col columns">
            ...
            <section class="MyAccountSection">
                ...
                <asp:Panel ID="uxMyAccountLinkPanel" runat="server" CssClass="HeaderLoginAccount">
                    <asp:HyperLink ID="uxMyAccountLink" runat="server" CssClass="MyAccountLink" NavigateUrl="~/accountdashboard.aspx">[$MyAccount]</asp:HyperLink>
                </asp:Panel>
            </section>
