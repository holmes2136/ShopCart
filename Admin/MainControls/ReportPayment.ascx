<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReportPayment.ascx.cs"
    Inherits="AdminAdvanced_MainControls_ReportPayment" %>
...
<uc1:AdminContent ID="uxAdminContent" runat="server" HeaderText="Payment Report">
    <MessageTemplate>
    ...
    <GridTemplate>
        <asp:GridView ID="uxGrid" runat="server" CssClass="Gridview1" SkinID="DefaultGridView"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="SumPaymentMethod" HeaderText="Use Count" SortExpression="SumPaymentMethod">
