<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProductKitProductList.ascx.cs"
    Inherits="Admin_Components_ProductKitProductList" %>
...
<%@ Register Src="ProductKitProductDetails.ascx" TagName="ProductKitProductDetails"
    TagPrefix="uc15" %>
        ...
        <asp:Panel ID="uxAddItemPanel" runat="server" CssClass="b6 pdl10 pdr10 pdb10 pdt10">
            <div class="mgt10">
                <div style="width: 850px; height: 500px; margin: auto; overflow: auto">
                    <uc15:ProductKitProductDetails ID="uxProductKitProductDetails" runat="server" />
                    <div class="Clear">
                    </div>
                    <div class="mgt10">
