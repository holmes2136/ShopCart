<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BestSellingControl.ascx.cs" Inherits="Themes_ResponsiveGreen_Components_Controls_BestSellingControl" %>
...
<div class="CommonProductItemStyle">
    <asp:Panel ID="uxBestSellingProductItemPanel" runat="server" CssClass="DummyCommonProductItemStyle">
        ...
        <div class="ProductBestSellingItem">
            ...
            <div class="CommonProductSpecialLabel">
                ...
                <asp:Panel ID="CommonProductRecurringPanel" runat="server" CssClass="CommonProductRecurringPanel"
                    Visible='<%# ConvertUtilities.ToBoolean( Eval("IsRecurring") ) %>'>
                    <asp:HyperLink ID="uxRecurringLink" runat="server" NavigateUrl='<%# Vevo.UrlManager.GetProductUrl( Eval( "ProductID" ).ToString(), Eval( "UrlName" ).ToString() ) %>'><img src="[$RecurringIcon]" class="RecurringProductImage" /></asp:HyperLink>
                </asp:Panel>
            </div>
        </div>
