<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ManufacturerSorting.ascx.cs"
    Inherits="Admin_MainControls_ManufacturerSorting" %>
    ...
    <GridTemplate>
        <div class="CommonAdminBorder Container-Box1">
            <div class="CategorySortingLabel">
                <asp:Label ID="uxManufacturerDescriptionLabel" runat="server" meta:resourcekey="lcManufacturerDescription"></asp:Label>
            </div>
