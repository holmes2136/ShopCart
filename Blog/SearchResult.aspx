<%@ Page Language="C#" MasterPageFile="~/Blog/Blog.master" AutoEventWireup="true"
    CodeFile="SearchResult.aspx.cs" Inherits="Blog_SearchResult" Title="Search Result" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="uxPlaceHolder" runat="Server">
    <div class="BlogList">
        <div class="BlogListTop">
            ...
            <asp:Label ID="uxDefaultTitle" runat="server" CssClass="BlogDetailsTopTitle" Text="[$SearchResultHeader]"></asp:Label>
