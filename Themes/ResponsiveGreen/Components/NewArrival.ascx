<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NewArrival.ascx.cs" Inherits="Themes_ResponsiveGreen_Components_NewArrival" %>
<%@ Register Src="NewArrivalItem.ascx" TagName="NewArrivalItem" TagPrefix="uc" %>
...
<asp:Panel ID="uxNewArrivalPanel" runat="server" CssClass="NewArrival">
    ...
    <div class="CenterBlockLeft">
        <div class="CenterBlockRight">
            <asp:UpdatePanel ID="uxNewArrialUpdate" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                <ContentTemplate>
                    <div id="uxNewArrialCarousel" runat="server" class="jcarousel-skin-tango">
                        ...
                        <ul>
                            <asp:Repeater ID="uxNewArrialRepeater" runat="server">
                                <ItemTemplate>
                                    <li>
                                        <uc:NewArrivalItem ID="uxNewArrivalItem" runat="server" />
                                    </li>
                                </ItemTemplate>
                            </asp:Repeater>
                        </ul>
