<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BlogCategoryList.ascx.cs"
    Inherits="Admin_MainControls_BlogCategoryList" %>
...
<%@ Register Src="../Components/Template/AdminContent.ascx" TagName="AdminContent"
    TagPrefix="uc1" %>
<uc1:AdminContent ID="uxAdminContent" runat="server" HeaderText="">
    <MessageTemplate>
    ...
    <ButtonCommandTemplate>
        ...
        <asp:Panel ID="uxConfirmPanel" runat="server" CssClass="ConfirmPanel b6 ac pdt10"
            ...
            <div class="ConfirmTitle">
                <asp:Label ID="uxConfirmLabel" runat="server" Text="<%$ Resources:BlogCategoryMessages, DeleteConfirmation %>"></asp:Label></div>
    ...
    <GridTemplate>
        <asp:GridView ID="uxGrid" runat="server" CssClass="Gridview1" SkinID="DefaultGridView"
            DataKeyNames="BlogCategoryID" OnDataBound="uxGrid_DataBound" AllowSorting="true"
            ...
            <Columns>
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <asp:CheckBox ID="uxCheck" runat="server" Visible='<%# (Eval("BlogCategoryID").ToString() == "1") ? false: true%>' />
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" Width="35px" />
                    <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="<%$ Resources:BlogCategoryFields, Name %>" SortExpression="Name">
                    <ItemTemplate>
                        <asp:Label ID="uxNameLable" runat="server" Text='<%# Eval("Name") %>'>
                        </asp:Label>
                        <asp:HiddenField ID="uxBlogCategoryIDHidden" Value='<%# Bind("BlogCategoryID") %>'
                            runat="server" />
                    </ItemTemplate>
                    <ItemStyle CssClass="pdl15" HorizontalAlign="Left" />
                    <HeaderStyle HorizontalAlign="Left" CssClass="pdl15" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="<%$ Resources:BlogCategoryFields, IsEnabled %>">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="<%$ Resources:BlogCategoryFields, EditCommand %>">
                    <ItemTemplate>
                        <vevo:AdvancedLinkButton ID="uxEditHyperLink" runat="server" ToolTip="<%$ Resources:BlogCategoryFields,  EditCommand %>"
                            PageName="BlogCategoryEdit.ascx" PageQueryString='<%# String.Format( "BlogCategoryID={0}", Eval("BlogCategoryID") ) %>'
            ...
            <EmptyDataTemplate>
                <asp:Label ID="uxEmptyMessageLabel" runat="server" Text="<%$ Resources:BlogCategoryMessages, TableEmpty  %>"></asp:Label>
            </EmptyDataTemplate>
        </asp:GridView>
    </GridTemplate>
</uc1:AdminContent>
