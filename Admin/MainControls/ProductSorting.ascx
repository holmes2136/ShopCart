<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProductSorting.ascx.cs"
    Inherits="AdminAdvanced_MainControls_ProductSorting" %>
    ...
    <GridTemplate>
        <div class="CommonAdminBorder Container-Box1">
            <div class="CategorySortingLabel">
                <asp:Label ID="uxCategoryDescriptionLabel" runat="server" meta:resourcekey="lcProductDescription"></asp:Label>
            </div>
